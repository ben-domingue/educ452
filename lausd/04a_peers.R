...
out<-list()
for (wt in c(0,.25,.5,.75,1)) out[[as.character(wt)]]<-simfun(wt=wt,te=te,ma0=ma0)
...
df<-data.frame(wt=names(z),true.re1,true.re2,total.re1,total.re2)

par(mgp=c(2,1,0),mar=c(3,3,1,10))
