...
## 4A
Can you build a DGM such that teachers decision to quit after the first year is governed by an entirely different process relative to that decision after subsequent years (and after the first year it can be governed by the exponential model we discussed in class)? Can you build it such that you can vary how strong this propensity to quit after the first year is?
