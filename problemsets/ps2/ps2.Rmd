...
```{r}
setwd("~/Dropbox/stanford/classes/edu452/data/") #You will need to set your own path
...
## 3B 
Now consider the basic STAR DGM but now with non-normal standard error. What are the implications here of this violation of the assumption of homoscedasticity?
